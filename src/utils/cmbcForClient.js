...
// 商户联合登录，并跳转商户url
export function loginForComm(beforeUrl, toUrl) {
  var p = {
    beforeUrl: beforeUrl,
    toUrl: toUrl
  };
...
function getClientInformation(methodNameOrParam) {
  if (
    methodNameOrParam == undefined ||
    methodNameOrParam == null ||
    methodNameOrParam == ""
  ) {
...
var title = "天天有奖";
var dec =
  "民生手机银行“天天有奖”！每天使用手机银行有机会获得5000元以内神秘礼品一份哟！更有海量话费、积分等你拿！机会难得，快来参加吧！"; //分享页面的描述
var weixinDec =
  "民生手机银行“天天有奖”！每天使用手机银行有机会获得5000元以内神秘礼品一份哟！更有海量话费、积分等你拿！机会难得，快来参加吧！";
var weiboDec =
  "民生手机银行“天天有奖”！每天使用手机银行有机会获得5000元以内神秘礼品一份哟！更有海量话费、积分等你拿！机会难得，快来参加吧！";
var weixinUrl =
  "http://mp.weixin.qq.com/s?__biz=MjM5MzMwNDQwNA==&mid=452427318&idx=1&sn=d40c5f46b4e05056957c4216375d9e8d#rd"; //响应页面
...
function sendJsonArray() {
  ...
  //图片地址重新赋值
  pictureURL =
    localStorage.getItem("phost") +
    "/CMBC_MPServer/css/images/marketplat16/share.jpg";
  var jsonArray = null;
  if (phoneType == "1") {
    //iphone
    jsonArray =
      '{"sharePanelData":[{"id":"SH001","callback":"backJsonData()"},{"id":"SH002","callback":"backJsonData1()"},{"id":"SH003","callback":"SinaWeibo()"},{"id":"SH005","callback":"QQZoom()"}]}';
  } else {
    ...
    jsonArray =
      '{"sharePanelData":[{"id":"SH001","callback":' +
      backJsonDataStr +
      '},{"id":"SH002","callback":' +
      backJsonDataStr1 +
      '},{"id":"SH003","callback":' +
...
function SinaWeibo() {
  ...
  var urlAddress =
    ...
    weiboUrl +
    "&pic=" +
    encodeURIComponent(pictureURL) +
    "&title=" +
    encodeURIComponent(weiboDec);
  var json = {
    shareUrl: urlAddress,
    shareTitleName: "新浪微博"
  };
...
function setWebitEvent(methodNameOrParam, evtCode) {
  // code:ios监听的code,b:ios
  // 回调的方法名
  var phoneType = "";
  phoneType = getPhoneType();
  alertDebug(
    "setWebitEvent.phoneType:" +
      phoneType +
      ",code:" +
      evtCode +
      ",methodNameOrParam:" +
...
function setAndroidWebitEvent(methodNameOrParam, evtCode) {
  alertDebug(
    "setAndroidWebitEvent.methodNameOrParam:" +
      methodNameOrParam +
      ",evtCode:" +
      evtCode
  );
